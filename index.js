...
function handleCommentBtnClick(tweetId){
  const commentInput = document.getElementById(tweetId)
      if(commentInput.value){
          const isComented = tweetsData.filter(function(tweet){
            return tweetId == tweet.uuid
          })
          isComented[0].replies.push({
                handle: `Scrimba ✅`,
...
`
    ...
    repliesHtml +=
         ` <div class="tweet-input-area">
            ...
            <textarea placeholder="Write your comment" class="comment" id="${tweet.uuid}"></textarea>
		</div>
        <button data-comment="${tweet.uuid}" id="comment-btn">Comment</button>`
    ...
    <div class="tweet-inner">
        ...
        <div>
            ...
            <div class="tweet-details">
                ...
                <span class="tweet-detail">
                    <i class="fa-solid fa-trash"  data-delete="${tweet.uuid}"></i></i>
                </span>
